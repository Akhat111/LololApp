...
namespace CompleteWeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        private string Location { get; set; } = "Shymkent";
        ...
        {
            var url = $"https://api.pexels.com/v1/seacrh?query={Location}&per_page=15&page=1";

            var result = await ApiCaller.Get(url, "563492ad6f91700001000001d0c49408b8fe47e189871008c856ad1e");
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/weather?q={Location}&appid=8cf2a498480922662e3672b22741b4f5&units=metric";
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=8cf2a498480922662e3672b22741b4f5&units=metric";
            var result = await ApiCaller.Get(url);
